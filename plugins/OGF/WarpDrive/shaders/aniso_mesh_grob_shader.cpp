    ...
    void AnisoMeshGrobShader::draw_ellipsoids() {
        ...
        if(program_ == 0) {
            ...
            program_ = glupCompileProgram(
                ...
                "  vec3 p;\n"
                "  dvec3 Up;\n" // [  Up  ]     [   |   |   ] -1
                "  dvec3 Vp;\n" // [  Vp  ]  =  [ U | V | W ]    (double precision needed)
                "  dvec3 Wp;\n" // [  Wp  ]     [   |   |   ]
                "  vec3 U_clip_space;\n"
                "  vec3 V_clip_space;\n"
                "  vec3 W_clip_space;\n"
                ...
                "   VertexOut.U_clip_space = M*color_in.xyz;\n"
                "   VertexOut.V_clip_space = M*tex_coord_in.xyz;\n"
                "   VertexOut.W_clip_space = M*normal_in.xyz;\n"
                "   VertexOut.Up = dvec3(color_in.xyz);\n"
                "   VertexOut.Vp = dvec3(tex_coord_in.xyz);\n"
                "   VertexOut.Wp = dvec3(normal_in.xyz);\n"
                ...
                "  emit_vertex_2(6); emit_vertex_2(7); emit_vertex_2(4); emit_vertex_2(5);\n"
                "  emit_vertex_2(0); emit_vertex_2(1); emit_vertex_2(2); emit_vertex_2(3);\n"
                "  emit_vertex_2(6); emit_vertex_2(7); \n"
                "  EndPrimitive();\n"
                "  emit_vertex_2(4); emit_vertex_2(0); emit_vertex_2(6); emit_vertex_2(2);\n"
                "  EndPrimitive();\n"
                "  emit_vertex_2(1); emit_vertex_2(5); emit_vertex_2(3); emit_vertex_2(7);\n"
                "  EndPrimitive();\n"  
                "}\n"
                ...
                "  dmat3 Mt = mat3(FragmentIn.Up, FragmentIn.Vp, FragmentIn.Wp); \n"
                "  dmat3 M  = transpose(Mt); \n" // M is the inverse basis transform
                "  Ray R = glup_primary_ray();\n"
                "  dvec3 D = M * (dvec3(R.O - FragmentIn.p)); \n"
                "  dvec3 v = M * dvec3(R.V); \n"
                "  double a   = dot(v,v); \n"
                "  double b_p = dot(D,v); \n"
