    ...
    void AnisoMeshGrobShader::draw_ellipsoids() {
        ...
        if(program_ == 0) {
            ...
            program_ = glupCompileProgram(
                ...
                "out VertexData {\n"
                "  vec3 p;\n"
                "  dmat3 M;\n" // M  = [ U | V | W ]-1 (double precision needed)
                "  vec3 U_clip_space;\n"
                "  vec3 V_clip_space;\n"
                "  vec3 W_clip_space;\n"
                "} VertexOut;\n"
                ...
                "   VertexOut.U_clip_space = MVP33*color_in.xyz;\n"
                "   VertexOut.V_clip_space = MVP33*tex_coord_in.xyz;\n"
                "   VertexOut.W_clip_space = MVP33*normal_in.xyz;\n"
                "   dvec3 Up = dvec3(color_in.xyz);\n"
                "   dvec3 Vp = dvec3(tex_coord_in.xyz);\n"
                "   dvec3 Wp = dvec3(normal_in.xyz);\n"
                "   VertexOut.M = transpose(dmat3(Up/dot(Up,Up), Vp/dot(Vp,Vp), Wp/dot(Wp,Wp)));\n"
                "}\n"
                ...
                "  dvec3 D = FragmentIn.M * (dvec3(R.O - FragmentIn.p)); \n"
                "  dvec3 v = FragmentIn.M * dvec3(R.V); \n"
                "  double a   = dot(v,v); \n"
                "  double b_p = dot(D,v); \n"
                ...
                "     mat3 fM = mat3(FragmentIn.M); \n"
                "     mat3 fMt = transpose(fM); \n"
                "     vec3 N = fMt*(fM*w); \n"
