...
#include <swig/Include/swigwarn.h>

/*
[Bruno Levy] commented out
...
extern int SmartPointerEmit;    // smart pointer methods being emitted
// [Bruno Levy] renamed SmartPointer as SmartPointerEmit (name clash with Geogram)
