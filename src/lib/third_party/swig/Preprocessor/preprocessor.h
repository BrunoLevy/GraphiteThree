...
extern "C" {
  ...
  typedef void(*PreprocessorCommentCB)(String *comment_string, String *preprocessor_output);
  extern void Preprocessor_register_comment_CB(PreprocessorCommentCB cb);
