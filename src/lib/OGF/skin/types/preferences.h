...
#ifndef H_SKIN_APPLICATION_H
#define H_SKIN_APPLICATION_H

#include <OGF/skin/common/common.h>

/**
 * \file OGF/skin/types/preferences.h
...
//_________________________________________________________
    ...
    namespace Preferences {
         ...
         */
        void SKIN_API save_preferences();
	 ...
	 */
	void SKIN_API declare_preference_variable(const std::string& name);
	 ...
	 *  graphite /? or graphite -h
         */
        void SKIN_API declare_preference_variable(
	 ...
	 */
	bool SKIN_API preference_variable_is_declared(
