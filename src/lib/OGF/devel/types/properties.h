...
#ifndef H_OGF_DEVEL_TYPES_PROPERTIES_H
#define H_OGF_DEVEL_TYPES_PROPERTIES_H
...
/**
 * \file OGF/devel/types/properties.h
 * \details Types used by devel command arguments.
 */
...
namespace OGF {
    ...
    /**
     * \brief The name of a dynamic module (plugin).
