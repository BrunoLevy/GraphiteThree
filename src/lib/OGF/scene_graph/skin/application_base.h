...
#ifndef H_SCENE_GRAPH_SKIN_APPLICATION_BASE_H
#define H_SCENE_GRAPH_SKIN_APPLICATION_BASE_H
...
/**
 * \file OGF/scene_graph/application/application_base.h
...
namespace OGF {
     ...
     *  material.
     */
    gom_class SCENE_GRAPH_API ApplicationBase : public Object {
