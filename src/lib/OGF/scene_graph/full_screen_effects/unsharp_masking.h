...
#ifndef H_OGF_SCENE_GRAPH_FULL_SCREEN_EFFECTS_UM_H
#define H_OGF_SCENE_GRAPH_FULL_SCREEN_EFFECTS_UM_H
...
/**
 * \file OGF/scene_graph/full_screen_effects/unsharp_masking.h
...
namespace OGF {
     ...
     */
    gom_class SCENE_GRAPH_API UnsharpMasking : public FullScreenEffect {
    public:
