...
#ifndef H_OGF_SCENE_GRAPH_FULL_SCREEN_EFFECTS_FSE_H
#define H_OGF_SCENE_GRAPH_FULL_SCREEN_EFFECTS_FSE_H

#include <OGF/scene_graph/common/common.h>
#include <OGF/gom/types/node.h>

/**
 * \file OGF/scene_graph/full_screen_effects/full_screen_effect.h
...
namespace OGF {
    ...
    gom_class SCENE_GRAPH_API FullScreenEffect : public Object {
    public:
     ...
     *  does nothing.
     */
    gom_class SCENE_GRAPH_API PlainFullScreenEffect : public FullScreenEffect {
    public:
        /**
