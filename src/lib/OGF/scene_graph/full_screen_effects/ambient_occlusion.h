...
#ifndef H_OGF_SCENE_GRAPH_FULL_SCREEN_EFFECTS_AO_H
#define H_OGF_SCENE_GRAPH_FULL_SCREEN_EFFECTS_AO_H
...
/**
 * \file OGF/scene_graph/full_screen_effects/ambient_occlusion.h
...
namespace OGF {
     ...
     * \brief GOM wrapper around AmbientOcclusionImpl.
     */
    gom_class SCENE_GRAPH_API AmbientOcclusion : public FullScreenEffect {
    public:
        /**
