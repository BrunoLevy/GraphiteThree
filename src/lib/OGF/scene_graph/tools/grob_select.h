...
#ifndef H_OGF_SCENE_GRAPH_TOOLS_GROB_SELECT_H
#define H_OGF_SCENE_GRAPH_TOOLS_GROB_SELECT_H

#include <OGF/scene_graph/common/common.h>
#include <OGF/scene_graph/tools/tool.h>

/**
 * \file OGF/scene_graph/tools/grob_select.h
...
namespace OGF {
    ...
    gom_class SCENE_GRAPH_API GrobSelect : public Tool {
    public:
        /**
