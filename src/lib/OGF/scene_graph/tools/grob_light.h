...
#ifndef H_OGF_SCENE_GRAPH_TOOLS_GROB_LIGHT_H
#define H_OGF_SCENE_GRAPH_TOOLS_GROB_LIGHT_H
...
/**
 * \file OGF/scene_graph/tools/grob_pan.h
...
namespace OGF {
    ...
    gom_class SCENE_GRAPH_API GrobLight : public Tool {
    public:
        /**
