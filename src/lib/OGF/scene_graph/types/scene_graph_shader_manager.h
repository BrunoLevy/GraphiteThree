...
#ifndef H_OGF_SCENE_GRAPH_TYPES_SCENE_GRAPH_SHDR_MGR_H
...
/**
 * \file OGF/scene_graph/types/scene_graph_shader_manager.h
...
namespace OGF {
     ...
     *  SceneGraph.
     */
    gom_class SCENE_GRAPH_API SceneGraphShaderManager : public Object {
    public:
