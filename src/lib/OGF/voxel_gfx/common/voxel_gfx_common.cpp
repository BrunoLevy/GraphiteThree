...
namespace OGF {
    ...
    void voxel_gfx_libinit::initialize() {

        Logger::out("Init") << "<voxel_gfx>" << std::endl;

        //**************************************************************

        gom_package_initialize(voxel_gfx) ;
        ogf_register_grob_shader<VoxelGrob,PlainVoxelGrobShader>();

        //**************************************************************

        Module* module_info = new Module;
        module_info->set_name("voxel_gfx");
        ...
        Module::bind_module("voxel_gfx", module_info);

        Logger::out("Init") << "</voxel_gfx>" << std::endl;
    }

    void voxel_gfx_libinit::terminate() {
        Logger::out("Init") << "<~voxel_gfx>" << std::endl;
        ...
        Module::unbind_module("voxel_gfx");
        Logger::out("Init") << "</~voxel_gfx>" << std::endl;
    }

    voxel_gfx_libinit::voxel_gfx_libinit() {
        increment_users();
    }
    ...
    void voxel_gfx_libinit::increment_users() {
    ...
    void voxel_gfx_libinit::decrement_users() {
        count_--;
        if(count_ == 0) {
            terminate();
        }
    ...
    int voxel_gfx_libinit::count_ = 0;
}
...
extern "C" void VOXEL_GFX_API OGF_voxel_gfx_initialize(void);
extern "C" void VOXEL_GFX_API OGF_voxel_gfx_initialize() {
    OGF::voxel_gfx_libinit::increment_users();
}

extern "C" void VOXEL_GFX_API OGF_voxel_gfx_terminate(void);
extern "C" void VOXEL_GFX_API OGF_voxel_gfx_terminate() {
    OGF::voxel_gfx_libinit::decrement_users();
}
