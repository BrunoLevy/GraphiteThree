...
#ifndef H_OGF_SCENE_GRAPH_GFX_TRANSFORMS_RAY_PICKER_H
#define H_OGF_SCENE_GRAPH_GFX_TRANSFORMS_RAY_PICKER_H
...
/**
 * \file OGF/scene_graph_gfx/transforms/ray_picker.h
...
namespace OGF {
     ...
     *  send to it.
     */
    SCENE_GRAPH_GFX_API std::ostream& operator<<(
	std::ostream& out, const RayPick& ev
    );
     ...
     * \see RayPick
     */
    gom_class SCENE_GRAPH_GFX_API RayPicker : public Object {
    public:
        /**
