...
#ifndef H_OGF_SCENE_GRAPH_TOOLS_TOOLS_MANAGER_H
#define H_OGF_SCENE_GRAPH_TOOLS_TOOLS_MANAGER_H
...
/**
 * \file OGF/scene_graph_gfx/tools/tools_manager.h
...
namespace OGF {
    ...
    gom_class SCENE_GRAPH_GFX_API ToolsManager : public Node {
    public:
        /**
